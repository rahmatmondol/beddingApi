<x-app-layout>
    <div class="flat-tabs">
        <div class="section-menu-left">
            <div class="box-logo">
                <a href="index.html"><img src="{{ asset('user') }}/assets/images/logo/logo.png" alt=""></a>
            </div>
            ...
            <div class="over-content">
                <div class="content">
                    <h6>Services</h6>
                    <ul class="menu-tab">
                        <li class="tablinks active" data-tabs="market">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g opacity="0.2">
                                    <path d="M6.75731 9.35159V15.64" stroke="white" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M11.0351 6.34253V15.64" stroke="white" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M15.2431 12.6746V15.6401" stroke="white" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                ...
                                <g opacity="0.2">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        fill="white" />
                                    <mask id="mask0_1075_3648" style="mask-type:luminance" maskUnits="userSpaceOnUse"
                                        x="15" y="1" width="6" height="6">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <mask id="mask1_1075_3648" style="mask-type:luminance" maskUnits="userSpaceOnUse"
                                        x="1" y="2" width="20" height="19">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <ul class="menu-tab">
                        <li class="tablinks" data-tabs="tf-collection">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g opacity="0.2">
                                    <mask id="mask0_1075_14628" style="mask-type:luminance" maskUnits="userSpaceOnUse"
                        ...
                        <li class="tablinks" data-tabs="favorite">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g opacity="0.2">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <li class="tablinks" data-tabs="wallet">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g opacity="0.2">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        fill="white" />
                                    <mask id="mask0_1075_5813" style="mask-type:luminance" maskUnits="userSpaceOnUse"
                                        x="1" y="2" width="20" height="19">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <li class="tablinks" data-tabs="history">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g opacity="0.2">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                ...
                                <g opacity="0.2">
                                    <path
                                        ...
                                        stroke="white" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M19.9907 11.0196H8.95312" stroke="white" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M17.3047 8.34741L19.9887 11.0195L17.3047 13.6925" stroke="white"
                                        stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                </g>
                            </svg>
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                ...
                                "disableOnInteraction": false
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img src="{{ asset('user') }}/assets/images/item-background/bg-action-1.png"
                                                    alt="">
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="{{ asset('user') }}/assets/images/item-background/bg-action-1.png"
                                        ...
                                        <div class="wrap-box-card">
                                            <div class="col-item">
                                                <div class="tf-card-box style-1">
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('user') }}/assets/images/box-item/card-item-01.jpg"
                                                                alt="">
                                                        </a>
                                            ...
                                            <div class="col-item">
                                                <div class="tf-card-box style-1">
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('user') }}/assets/images/box-item/card-item-02.jpg"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                        <div class="featured-countdown">
                                                    ...
                                                    <div class="author flex items-center">
                                                        <div class="avatar">
                                                            <img src="{{ asset('user') }}/assets/images/avatar/avatar-box-02.jpg"
                                                                alt="Image">
                                                        </div>
                                                        <div class="info">
                                                            <span>Created by:</span>
                                            ...
                                            <div class="col-item">
                                                <div class="tf-card-box style-1">
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('user') }}/assets/images/box-item/card-item-03.jpg"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                        <div class="featured-countdown">
                                            ...
                                            <div class="col-item">
                                                <div class="tf-card-box style-1">
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('user') }}/assets/images/box-item/card-item-04.jpg"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                        <div class="featured-countdown">
                                                    ...
                                                    <div class="author flex items-center">
                                                        <div class="avatar">
                                                            <img src="{{ asset('user') }}/assets/images/avatar/avatar-box-04.jpg"
                                                                alt="Image">
                                                        </div>
                                                        <div class="info">
                                                            <span>Created by:</span>
                        ...
                        <div class="side-bar">
                            <div class="widget widget-recently">
                                ...
                                <div class="card-small-main">
                                    <img src="{{ asset('user') }}/assets/images/blog/sidebar-05.jpg" alt="">
                                ...
                                <div class="card-small">
                                    <div class="author">
                                        <img src="{{ asset('user') }}/assets/images/blog/sidebar-07.jpg" alt="">
                                        <div class="info">
                                            <h6><a href="#">Propw</a></h6>
                                            <p><a href="#">@themes</a></p>
                                        </div>
                                ...
                                <div class="card-small">
                                    <div class="author">
                                        <img src="{{ asset('user') }}/assets/images/blog/sidebar-08.jpg" alt="">
                                        <div class="info">
                                            <h6><a href="#">Propw</a></h6>
                                            <p><a href="#">@themes</a></p>
                                        </div>
                            ...
                            <div class="widget widget-coins">
                                ...
                                <div class="widget-coins-item flex items-center mb-20">
                                    <img src="{{ asset('user') }}/assets/images/box-icon/coin-01.png" alt="">
                                    <p><a href="#">Bitcoin</a></p>
                                </div>
                                <div class="widget-coins-item flex items-center mb-20">
                                    <img src="{{ asset('user') }}/assets/images/box-icon/coin-02.png" alt="">
                                    <p><a href="#">Ethereum</a></p>
                                </div>
                                <div class="widget-coins-item flex items-center mb-20">
                                    <img src="{{ asset('user') }}/assets/images/box-icon/coin-03.png" alt="">
                                    <p><a href="#">Cardano</a></p>
                                </div>
                                <div class="widget-coins-item flex items-center mb-20">
                                    <img src="{{ asset('user') }}/assets/images/box-icon/coin-04.png" alt="">
                                    <p><a href="#">Solana</a></p>
                                </div>
                                <div class="widget-coins-item flex items-center">
                                    <img src="{{ asset('user') }}/assets/images/box-icon/coin-05.png" alt="">
                                        ...
                                        <div class="wrap-box-card">
                                            <div class="col-item">
                                                <div class="tf-card-box style-4">
                                                    ...
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('user') }}/assets/images/box-item/card-item-17.jpg"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                    </div>
                                            ...
                                            <div class="col-item">
                                                <div class="tf-card-box style-4">
                                                    ...
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('user') }}/assets/images/box-item/card-item-18.jpg"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                    </div>
                                            ...
                                            <div class="col-item">
                                                <div class="tf-card-box style-4">
                                                    ...
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('user') }}/assets/images/box-item/card-item-19.jpg"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                    </div>
                                            ...
                                            <div class="col-item">
                                                <div class="tf-card-box style-4">
                                                    ...
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('user') }}/assets/images/box-item/card-item-20.jpg"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                    </div>
                                            ...
                                            <div class="col-item">
                                                <div class="tf-card-box style-4">
                                                    ...
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('user') }}/assets/images/box-item/card-item-21.jpg"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                    </div>
                                            ...
                                            <div class="col-item">
                                                <div class="tf-card-box style-4">
                                                    ...
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('user') }}/assets/images/box-item/card-item-22.jpg"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                    </div>
                                            ...
                                            <div class="col-item">
                                                <div class="tf-card-box style-4">
                                                    ...
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('user') }}/assets/images/box-item/card-item-23.jpg"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                    </div>
                                            ...
                                            <div class="col-item">
                                                <div class="tf-card-box style-4">
                                                    ...
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('user') }}/assets/images/box-item/card-item-24.jpg"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                    </div>
                    ...
                    <div class="wrapper-content">
                        <div class="inner-content">
                            ...
                            <div class="add-new-collection mb-40">
                                ...
                                <a href="#" class="tf-button style-1 w174 h50">Create<i
                                        class="icon-arrow-up-right2"></i></a>
                            </div>
                            <div class="heading-section">
                                            ...
                                            <div class="tf-card-collection">
                                                <a href="author-2.html">
                                                    <div class="media-images-collection">
                                                        <img src="{{ asset('user') }}/assets/images/box-item/img-collection-01.jpg"
                                                            alt="">
                                                        <img src="{{ asset('user') }}/assets/images/box-item/img-collection-02.jpg"
                                                            alt="">
                                                        <img src="{{ asset('user') }}/assets/images/box-item/img-collection-03.jpg"
                                                            alt="">
                                                        <img src="{{ asset('user') }}/assets/images/box-item/img-collection-04.jpg"
                                                            alt="">
                                                        <div class="author-poster">
                                                            <img src="{{ asset('user') }}/assets/images/avatar/avatar-01.png"
                                                                alt="" class="w-full">
                                                        </div>
                                                    </div>
                                                </a>
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-collection">
                                                <a href="author-2.html">
                                                    <div class="media-images-collection">
                                                        <img src="{{ asset('user') }}/assets/images/box-item/img-collection-05.jpg"
                                                            alt="">
                                                        <img src="{{ asset('user') }}/assets/images/box-item/img-collection-06.jpg"
                                                            alt="">
                                                        <img src="{{ asset('user') }}/assets/images/box-item/img-collection-07.jpg"
                                                            alt="">
                                                        <img src="{{ asset('user') }}/assets/images/box-item/img-collection-08.jpg"
                                                            alt="">
                                                        <div class="author-poster">
                                                            <img src="{{ asset('user') }}/assets/images/avatar/avatar-01.png"
                                                                alt="" class="w-full">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-collection">
                                                <a href="author-2.html">
                                                    <div class="media-images-collection">
                                                        <img src="{{ asset('user') }}/assets/images/box-item/img-collection-09.jpg"
                                                            alt="">
                                                        <img src="{{ asset('user') }}/assets/images/box-item/img-collection-10.jpg"
                                                            alt="">
                                                        <img src="{{ asset('user') }}/assets/images/box-item/img-collection-11.jpg"
                                                            alt="">
                                                        <img src="{{ asset('user') }}/assets/images/box-item/img-collection-12.jpg"
                                                            alt="">
                                                        <div class="author-poster">
                                                            <img src="{{ asset('user') }}/assets/images/avatar/avatar-01.png"
                                                                alt="" class="w-full">
                                        ...
                                        <div class="wrap-box-card">
                                            <div class="col-item">
                                                <div class="tf-card-box style-1">
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('user') }}/assets/images/box-item/card-item-25.jpg"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                        <div class="featured-countdown">
                                            ...
                                            <div class="col-item">
                                                <div class="tf-card-box style-1">
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('user') }}/assets/images/box-item/card-item-26.jpg"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                        <div class="featured-countdown">
                                            ...
                                            <div class="col-item">
                                                <div class="tf-card-box style-1">
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('user') }}/assets/images/box-item/card-item-27.jpg"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                        <div class="featured-countdown">
                                            ...
                                            <div class="col-item">
                                                <div class="tf-card-box style-1">
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('user') }}/assets/images/box-item/card-item-28.jpg"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                        <div class="featured-countdown">
                                            ...
                                            <div class="col-item">
                                                <div class="tf-card-box style-1">
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('user') }}/assets/images/box-item/card-item-29.jpg"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                        <div class="featured-countdown">
                                            ...
                                            <div class="col-item">
                                                <div class="tf-card-box style-1">
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('user') }}/assets/images/box-item/card-item-30.jpg"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                        <div class="featured-countdown">
                                            ...
                                            <div class="col-item">
                                                <div class="tf-card-box style-1">
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('user') }}/assets/images/box-item/card-item-31.jpg"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                        <div class="featured-countdown">
                                            ...
                                            <div class="col-item">
                                                <div class="tf-card-box style-1">
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('user') }}/assets/images/box-item/card-item-32.jpg"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                        <div class="featured-countdown">
                ...
                <div id="wallet" class="tabcontent">
                    <div class="wrapper-content">
                        <div class="inner-content">
                            ...
                            <p>If you don't have a wallet, you can select a provider and create one now. <span
                                    class="tf-color button-connect-wallet">Learn more</span></p>
                            <div id="connect-wallet-grid">
                                <div class="wrap-box-card">
                                    <div class="col-item">
                                        <div class="box-wallet">
                                            <img src="{{ asset('user') }}/assets/images/box-icon/wallet-01.png" alt="">
                                    ...
                                    <div class="col-item">
                                        <div class="box-wallet">
                                            <img src="{{ asset('user') }}/assets/images/box-icon/wallet-02.png" alt="">
                                    ...
                                    <div class="col-item">
                                        <div class="box-wallet">
                                            <img src="{{ asset('user') }}/assets/images/box-icon/wallet-03.png" alt="">
                                    ...
                                    <div class="col-item">
                                        <div class="box-wallet">
                                            <img src="{{ asset('user') }}/assets/images/box-icon/wallet-04.png" alt="">
                                    ...
                                    <div class="col-item">
                                        <div class="box-wallet">
                                            <img src="{{ asset('user') }}/assets/images/box-icon/wallet-05.png" alt="">
                                    ...
                                    <div class="col-item">
                                        <div class="box-wallet">
                                            <img src="{{ asset('user') }}/assets/images/box-icon/wallet-06.png" alt="">
                                    ...
                                    <div class="col-item">
                                        <div class="box-wallet">
                                            <img src="{{ asset('user') }}/assets/images/box-icon/wallet-07.png" alt="">
                                            <h6><a href="#">Core</a></h6>
                                    ...
                                    <div class="col-item">
                                        <div class="box-wallet">
                                            <img src="{{ asset('user') }}/assets/images/box-icon/wallet-08.png" alt="">
                                            <h6><a href="#">Glow</a></h6>
                                    ...
                                    <div class="col-item">
                                        <div class="box-wallet">
                                            <img src="{{ asset('user') }}/assets/images/box-icon/wallet-09.png" alt="">
                                    ...
                                    <div class="col-item">
                                        <div class="box-wallet">
                                            <img src="{{ asset('user') }}/assets/images/box-icon/wallet-10.png" alt="">
                                    ...
                                    <div class="col-item">
                                        <div class="box-wallet">
                                            <img src="{{ asset('user') }}/assets/images/box-icon/wallet-11.png" alt="">
                                    ...
                                    <div class="col-item">
                                        <div class="box-wallet">
                                            <img src="{{ asset('user') }}/assets/images/box-icon/wallet-12.png" alt="">
                                    ...
                                    <div class="col-item">
                                        <div class="box-wallet">
                                            <img src="{{ asset('user') }}/assets/images/box-icon/wallet-13.png" alt="">
                                    ...
                                    <div class="col-item">
                                        <div class="box-wallet">
                                            <img src="{{ asset('user') }}/assets/images/box-icon/wallet-14.png" alt="">
                                            <h6><a href="#">OperaTouch</a></h6>
                                            <p>Morbi vehicula ante eget cursus posuere</p>
                                        </div>
                                    </div>
                            ...
                            <div id="connect-wallet-list">
                                <div class="box-wallet style-1">
                                    ...
                                    <a href="#" class="tf-button style-3">Connect <i
                                            class="icon-arrow-up-right2"></i></a>
                                </div>
                                <div class="box-wallet style-1">
                                    <img src="{{ asset('user') }}/assets/images/box-icon/wallet-02.png" alt="">
                                ...
                                <div class="widget-content-tab pt-10">
                                    <div class="widget-content-inner active">
                                        <div class="widget-history">
                                            <div class="widget-creators-item flex items-center">
                                                <div class="author flex items-center flex-grow">
                                                    <img src="{{ asset('user') }}/assets/images/avatar/avatar-small-01.png"
                                                        alt="">
                                                    <div class="info">
                                                        <h6><a href="#">Lorem NFT sold</a></h6>
                                                        <span><a href="#">Sold at 1.32 ETH</a></span>
                                            ...
                                            <div class="widget-creators-item flex items-center">
                                                <div class="author flex items-center flex-grow">
                                                    <img src="{{ asset('user') }}/assets/images/avatar/avatar-small-02.png"
                                                        alt="">
                                                    <div class="info">
                                                        <h6><a href="#">New NFT uploaded</a></h6>
                                                        <span><a href="#">By Marisol Pena</a></span>
                                            ...
                                            <div class="widget-creators-item flex items-center">
                                                <div class="author flex items-center flex-grow">
                                                    <img src="{{ asset('user') }}/assets/images/avatar/avatar-small-03.png"
                                                        alt="">
                                                    <div class="info">
                                                        <h6><a href="#">You followed a creator</a></h6>
                                                        <span><a href="#">Jane Cooper</a></span>
                                            ...
                                            <div class="widget-creators-item flex items-center">
                                                <div class="author flex items-center flex-grow">
                                                    <img src="{{ asset('user') }}/assets/images/avatar/avatar-small-04.png"
                                                        alt="">
                                                    <div class="info">
                                                        <h6><a href="#">You placed a bid</a></h6>
                                                        <span><a href="#">Whirl wind NFT</a></span>
                            ...
                            <div class="widget-edit mb-30 avatar">
                                ...
                                <form action="#">
                                    <div class="uploadfile flex">
                                        <img src="{{ asset('user') }}/assets/images/avatar/avatar-07.png" alt="">
                                        <div>
                                ...
                                <form id="commentform" class="comment-form" novalidate="novalidate">
                                    <div class="flex gap30">
                                        ...
                                        <fieldset class="tel">
                                            ...
                                            <input type="tel" id="tel" placeholder="Your phone" name="tel" tabindex="2"
                                    ...
                                    <fieldset class="message">
                                        ...
                                        <textarea id="message" name="message" rows="4"
                                            placeholder="Say something about yourself" tabindex="4" aria-required="true"
                                            required=""></textarea>
                                    </fieldset>
                                    <div class="flex gap30">
                                        <fieldset class="name">
                            ...
                            <div class="widget-edit mb-30 password">
                                ...
                                <form id="commentform" class="comment-form" novalidate="novalidate">
                                    ...
                                    <fieldset class="password">
                                        ...
                                        <input type="text" id="password" placeholder="Enter your Old password"
                                            name="password" tabindex="2" value="" aria-required="true" required="">
                                    </fieldset>
                                    <fieldset class="password">
                                        <label>New password</label>
                                        <input type="text" id="password" placeholder="Enter your New password"
                                            name="password" tabindex="2" value="" aria-required="true" required="">
                                    </fieldset>
                                    <fieldset class="password">
...
<script>
    ...
    var initialCenter = { lat: 23.8103, lng: 90.4125 };
