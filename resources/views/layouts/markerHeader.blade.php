        ...
        <div class="widget-search">
            <form action="#" method="get" role="search" class="search-form relative">
                <input type="search" id="search" class="search-field style-1"
                    placeholder="Search artwork, collection..." value="" name="s" title="Search for"
                    required="">
                ...
                <div class="avatar_popup">
                    ...
                    <div class="widget-recently">
                        <div class="card-small">
                            <div class="author">
                                <img src="{{ asset('user') }}/assets/images/blog/sidebar-06.jpg" alt="">
                                <div class="info">
                ...
                <div class="avatar_popup2">
                    <div class="">
                        <div class="links">
                            ...
                            <a class="block mb-4" class="mt-10" href="profile.html">
                            ...
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button type="submit" class="flex" style="background: transparent;color: #fff;padding: 10px 0;">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
