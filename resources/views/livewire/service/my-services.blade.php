                                    ...
                                    <div class="tf-card-box style-1">
                                        <div class="card-media">
                                            ...
                                            <div class="button-place-bid">
                                                <a href="{{ route('service.details', $service->id) }}" wire:navigate class="tf-button mb-2"><span>Preview</span></a>
                                                <a href="{{ route('auth-service-edit', $service->id) }}" wire:navigate class="tf-button"><span>Edit</span></a>
                                            </div>
                        ...
                        <div class="wrap-box-card">
                            <div class="col-item">
                                <div class="tf-card-box style-1">
                                    <div class="card-media">
                                        <a href="#">
                                            <img src="{{ asset('user') }}/assets/images/box-item/card-item-53.jpg"
                                                alt="">
                                        </a>
                                    ...
                                    <div class="author flex items-center">
                                        <div class="avatar">
                                            <img src="{{ asset('user') }}/assets/images/avatar/avatar-box-03.jpg"
                                                alt="Image">
                                        </div>
                                        <div class="info">
                                            <span>Created by:</span>
