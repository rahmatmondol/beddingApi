...
@section('breadcrumb-items')
    ...
    <li class="breadcrumb-item active" aria-current="page">Zone Inputs</li>
@endsection
                ...
                <div class="card-body p-4">
                    <form class="row g-3" id="zoneForm" method="post" action="{{ route('zone.store') }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="input1" name="name" placeholder="Zone Name" required>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="d-md-flex d-grid justify-content-end gap-3">
                                <button type="button" class="btn btn-primary px-4" onclick="submitForm()">Submit</button>
                                <button type="button" class="btn btn-light px-4" id="reset_btn" onclick="resetForm()">Reset</button>
                            </div>
                        </div>
                    </form>
                </div>
